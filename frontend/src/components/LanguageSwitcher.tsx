    ...
    <div ref={ref} className="relative">
      ...
      {open && (
        <>
          ...
          {/* Mobile: bottom sheet | Desktop: dropdown (opens upward in sidebar, downward otherwise) */}
          <div className={`fixed bottom-0 left-0 right-0 z-50 md:absolute md:w-80 ${
            mode === 'full'
              ? 'md:bottom-full md:mb-2 md:left-0 md:right-auto md:top-auto'
              : 'md:bottom-auto md:top-full md:mt-2 md:right-0 md:left-auto'
          }`}>
            <div className="bg-white border border-[var(--color-outline-variant)] rounded-t-2xl md:rounded-2xl shadow-lg max-h-[60vh] md:max-h-[80vh] flex flex-col">
              ...
              <div className="overflow-y-auto overscroll-contain p-2" style={{ WebkitOverflowScrolling: 'touch' }}>
